# backup-to-ftp
Simple docker container to backup a directory to FTP as a zip file. Born out of the requirement to backup a self-hosted Minecraft world to an external server. 
